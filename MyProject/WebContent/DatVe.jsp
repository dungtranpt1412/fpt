				...
				<div class="row">
					<div class="booking-form">
						...
						<form>
							<div class="row">
								<div class="col-md-6" style="margin-top: 5px;">
									<div style="font-size: 15px" class="form-group">
										<b> Nơi Đi:</b></span> <select class="form-control">
											<option>Hà Nội</option>
											<option>2</option>
											<option>3</option>
										</select> <span class="select-arrow"
											style="color: black; padding-top: 5px;"></span>
									</div>
								</div>
								<div class="col-md-6">
									<div style="font-size: 15px" class="form-group">
										<span class="form-label"><b>Nơi Đến:</b></span> <select
											class="form-control">
											<option>1</option>
											<option>2</option>
											<option>3</option>
							...
							<div class="form-btn">
								<button class="submit-btn" style="background-color: green">Tìm
									Kiếm</button>
							</div>
						</form>
					</div>
