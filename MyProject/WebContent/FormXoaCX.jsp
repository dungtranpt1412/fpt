...
<hr class="sidebar-divider">
		...
		<h2 style="margin-left: 240px"><b>Xóa Chuyến Xe</b></h2><br>
  				<div class="row">
					<label class="col-25" for="fname">Mã Chuyến Xe</label>		
					<input class="col-75" type="text" id="fname" name="txtmakh"
							placeholder="Vui lòng nhập userID" readonly="readonly">
				</div>
				<div class="row">
					<label class="col-25" for="lname">Tên Chuyến Xe</label>
					<input class="col-75" type="text" id="lname" name="txttenkh"
							placeholder="Vui lòng nhập password" readonly="readonly">
				</div>
				<div class="row">
					<label class="col-25" for="lname">Mã Tuyến</label>
					<input class="col-75" type="text" id="lname" name="txtdiachi"
							placeholder="Vui lòng nhập họ tên" readonly="readonly">
							</div>
							<div class="row">
					<label class="col-25" for="lname">Giờ Đi</label>
					<input class="col-75" type="text" id="lname" name="txtsdt"
							placeholder="Vui lòng nhập ngày sinh" readonly="readonly">
							</div>
							<div class="row">
					<label class="col-25" for="lname">Giờ Đến</label>
					<input class="col-75" type="text" id="lname" name="txtemail"
							placeholder="Vui lòng nhập giới tính" readonly="readonly">
							</div>
							<div class="row">
					<label class="col-25" for="lname">UserID</label>
					<input class="col-75" type="text" id="lname" name="txtemail"
							placeholder="Vui lòng nhập cmnd" readonly="readonly">
							</div>
							<div class="row">
					<label class="col-25" for="lname">Chỗ Trống</label>
					<input class="col-75" type="text" id="lname" name="txtemail"
							placeholder="Vui lòng nhập điện thoại" readonly="readonly">
							</div>
							<div class="row">
					<label class="col-25" for="lname">Mã Tài Xế</label>
					<input class="col-75" type="text" id="lname" name="txtemail"
							placeholder="Vui lòng nhập email" readonly="readonly">
							</div><br>
