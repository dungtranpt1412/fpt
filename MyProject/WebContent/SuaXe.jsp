...
<marquee><h1 style="color: blue;">Hệ Thống Quản Lý Vé Xe Khách</h1></marquee>
				...
				<html:form style="width: 1000px; margin-left: 130px;"
					...
					<div class="row">
						...
						<html:text property="maXe" styleClass="col-75" styleId="fname"
							readonly="true" style="background: #e5dede;"></html:text>
					</div>
					<div class="row">
						<label class="col-25" for="lname">Tên Xe</label>
						<html:text property="tenXe" styleClass="col-75" styleId="fname"></html:text>
						<span style="color: red;margin: 17px;font-weight: bold;">*</span>
					</div>
					<div class="row">
						<label class="col-25" for="lname">Biển Số</label>
						<html:text property="bienSo" styleClass="col-75" styleId="fname"></html:text>
						<span style="color: red;margin: 17px;font-weight: bold;">*</span>
					</div>
					<div class="row">
						<label class="col-25" for="lname">Số Ghế</label>
						<html:text property="soGhe" styleClass="col-75" styleId="fname"></html:text>
						<span style="color: red;margin: 17px;font-weight: bold;">*</span>
					</div>
					<div class="row">
						<label class="col-25" for="lname">Tên Nhà Xe</label>
						<html:text property="tenNhaXe" styleClass="col-75" styleId="fname"></html:text>
						<span style="color: red;margin: 17px;font-weight: bold;">*</span>
					</div>
					<br>
					<div class="row">
