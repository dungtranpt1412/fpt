...
<marquee><h1 style="color: blue;">Hệ Thống Quản Lý Vé Xe Khách</h1></marquee>
				...
				<html:form style="width: 1000px; margin-left: 130px;"
					...
					<div class="row">
						...
						<html:text property="tenTuyen" styleClass="col-75" styleId="fname"
							readonly="true" style="background: #e5dede;"></html:text>
					</div>
					<div class="row">
						<label class="col-25" for="lname">Điểm đi</label>
						<html:text property="diemDi" styleClass="col-75" styleId="fname"
							readonly="true" style="background: #e5dede;"></html:text>
					</div>
					<div class="row">
						<label class="col-25" for="lname">Điểm đến</label>
						<html:text property="diemDen" styleClass="col-75" styleId="fname"
							readonly="true" style="background: #e5dede;"></html:text>
					</div>

					<div class="row">
						<label class="col-25" for="lname">Bảng giá</label>
						<html:text property="bangGia" styleClass="col-75" styleId="fname"
							readonly="true" style="background: #e5dede;"></html:text>
					</div>
					<br>
					<div class="row">
