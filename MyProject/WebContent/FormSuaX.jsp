...
<hr class="sidebar-divider">
		...
		<h2 style="margin-left: 240px"><b>Sửa Xe</b></h2><br>
  				<div class="row">
				...
				<div class="row">
					...
					<input class="col-75" type="text" id="lname" name="txtdiachi"
							placeholder="Vui lòng nhập biển xe">
							</div>
							<div class="row">
					...
					<input class="col-75" type="text" id="lname" name="txtemail"
							placeholder="Vui lòng nhập mã loại xe">
							</div>
						<br>
							<div class="row">
				<input style="margin-left: 525px" type="submit" value="Sủa" name="Sua"> 
